    ...
    public static class Vector2Utils
    {
        ...
        public static Vector2 ClampMagnitude(ref Vector2 vector, float maxLength)
        {
            ...
            if (sqrMagnitude > maxLength * maxLength)
            {
                ...
                // These intermediate variables force the intermediate result to be of float precision.
                // Without this, the intermediate result can be of higher precision, which changes behavior.
